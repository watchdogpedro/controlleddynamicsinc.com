...
export default function PartnersPage() {
 ...
 description: 'AngleLock manufactures breakthrough aluminum framing components that form the foundation of our structural systems. Their patented mechanical locking technology replaces friction-based friction-based connections with mechanically locked joints that are 10x stronger and require zero maintenance.',
 technologies: [
 ...
 description: '10x stronger than traditional friction-based systems with mechanical locks that rival welded steel joints'
 },
 {
 icon: Cog,

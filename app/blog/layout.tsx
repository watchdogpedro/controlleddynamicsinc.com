...
export const metadata: Metadata = {
 ...
 description: "Expert insights on aluminum extrusion systems, friction-based framing, modular construction, and industrial structural engineering. Compare friction-based alternatives and learn best practices.",
 keywords: [
 "aluminum extrusion guide",
 "friction-based framing",
 "T-SLOT alternative",
 ...
 title: "Engineering Insights & Technical Guides",
 description: "Expert articles on aluminum framing, friction-based alternatives, and structural engineering.",

...
export default function BlogPage() {
 ...
 description="Get expert articles on aluminum framing systems, friction-based alternatives, and structural engineering delivered to your inbox. Join 500+ engineers and manufacturers."
 />
 </Container>
 </section>
 ...
 <Button variant="ghost" size="lg">Compare vs friction-based</Button>
 </Link>
 </div>
 </div>
 </Container>

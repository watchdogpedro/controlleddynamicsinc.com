...
const faqCategories: FAQCategory[] = [
 ...
 faqs: [
 {
 question: 'What makes AngleLock different from traditional friction-based aluminum framing?',
 answer: 'AngleLock uses a patented 5-plane anchoring system that creates mechanically locked joints, not friction-based connections. Traditional friction-based systems rely on bolt tension against slot walls, which loosens over time—especially under vibration. AngleLock connections actually tighten under load and provide 10x the strength of standard friction-based systems, rivaling welded steel while maintaining full modularity.'
 },
 {
 question: 'How does AngleLock handle vibration?',
 answer: 'This is where AngleLock truly excels. The mechanical locking mechanism creates joints that tighten under vibration rather than loosening. Traditional friction-based fasteners work loose in high-vibration environments, requiring constant maintenance and re-tightening. AngleLock structures have operated in high-vibration applications for years with zero maintenance and no loss of rigidity—critical for precision equipment, robotics, and machine tools.'
 },
 {
 question: 'Can I reconfigure an AngleLock structure after it\'s built?',
 answer: 'Absolutely. That\'s one of the key advantages. You can fully disassemble and reconfigure AngleLock structures without weakening the connections. Unlike welded steel (permanent) or traditional friction-based (weakens with repeated assembly), AngleLock maintains full strength through multiple reconfigurations. We have customers who have modified their structures 8-10 times over several years with no degradation in performance.'
 },
 {
 ...
 answer: 'We welcome facility visits by appointment. Seeing AngleLock connections in person and understanding the assembly process helps many customers appreciate the technology. We can show examples of completed structures and demonstrate the superior rigidity versus traditional friction-based systems. We also have case studies, photos, and technical documentation we can share during the consultation process. Contact us to schedule a visit.'
 }
 ]
 }
];

function FAQ({ faq, index }: { faq: FAQ; index: number }) {

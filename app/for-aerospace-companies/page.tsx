...
export const metadata: Metadata = {
 ...
 description: 'Precision structural framing systems for aerospace and defense companies including Boeing, SpaceX, Tesla, Lockheed Martin, Northrop Grumman, General Dynamics, and Raytheon. Superior mechanical locking for satellite assembly fixtures, GSE, avionics test stands, and cleanroom applications. 10x stronger with micron-level precision.',
 keywords: [
...
export default function AerospaceCompaniesPage() {
 ...
 description: 'Unlike friction-based systems where connections loosen over time, AngleLock joints actually tighten under vibration - critical for avionics testing.',
 stat: '0',
 label: 'Loosening'
 },
 {
 ...
 <th className="text-center p-4 font-['Barlow_Condensed'] text-xl">Other Systems</th>
 <th className="text-center p-4 font-['Barlow_Condensed'] text-xl">Welded Steel</th>
 </tr>
 </thead>
 <tbody>
 {[
 { requirement: 'Precision (micron-level)', anglelock: '±5μm', other: '±50μm', welded: '±25μm' },
 { requirement: 'Vibration Resistance', anglelock: 'Excellent (self-tightening)', other: 'Poor (loosens over time)', welded: 'Good (but permanent)' },
 { requirement: 'Reconfiguration Time', anglelock: '4 hours', other: '8 hours', welded: 'Not possible' },
 { requirement: 'Load Capacity (strength)', anglelock: '10x stronger', other: 'Baseline', welded: 'Excellent' },
 { requirement: 'Cleanroom Compatible', anglelock: 'Yes (non-shedding)', other: 'Limited (fabric covers)', welded: 'Yes (but rust risk)' },
 { requirement: 'Assembly Time', anglelock: '50% faster', other: 'Baseline', welded: 'Very slow' },
 { requirement: 'Maintenance Required', anglelock: 'Zero', other: 'Frequent re-tightening', welded: 'Corrosion prevention' },
 { requirement: 'Future Modifications', anglelock: 'Unlimited', other: 'Yes', welded: 'Not possible' }
 ].map((row, idx) => (
 ...
 <td className="p-4 text-center text-[#6B7C93]">{row.other}</td>

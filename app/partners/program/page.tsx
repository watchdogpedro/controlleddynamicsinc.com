...
export const metadata: Metadata = {
  ...
  description: 'Join the AngleLock partner program for machine builders, fabricators, and distributors. Get exclusive pricing, training, marketing support, and engineering resources. Differentiate your business from 80/20 shops.',
  keywords: [
    ...
    '80/20 distributor alternative', 'T-slot dealer program', 'aluminum extrusion distributor',
          ...
          <Container>
            <div className="max-w-5xl">
              ...
              <p className="text-2xl text-white/90 mb-6 leading-relaxed">
                Stop competing with every other 80/20 shop on price.
              ...
              {[
                {
                  ...
                  description: 'Tiered partner discounts from 10-35% off list pricing based on volume and partnership level. Better margins than commodity T-slot.'
                },
                {
                  icon: BookOpen,
                ...
                <Card className="p-6 border-2 border-[#C9A227]">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      'Existing 80/20 or T-slot distributors',
        ...
        <section className="py-20 bg-[#0A1628]">
          <Container>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {[
                {
                  quote: "Switching from 80/20 to AngleLock was the best business decision we made. Our margins improved, callbacks disappeared, and we're winning projects we couldn't before.",
                ...
                {
                  quote: "The engineering support is incredible. They helped us win a major aerospace contract that required precision we couldn't achieve with T-slot.",
          ...
          <Container>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              {[
                ...
                {
                  q: 'Can I sell both 80/20 and AngleLock?',
                  a: 'Yes. Many partners continue to offer T-slot solutions for applications where it makes sense, while positioning AngleLock for applications that demand superior performance. We don\'t require exclusivity at the Authorized or Preferred levels.'
                },
                {
          ...
          <Container>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-white/80 mb-8">
                ...
                no other 80/20 shop can offer. Better technology. Better margins. Better results.
              </p>

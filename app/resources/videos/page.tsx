...
export default function VideosPage() {
 ...
 AngleLock vs. Traditional friction-based Systems
 </p>
 </div>
 ...
 <div>
 <h3 className="text-2xl font-bold text-white mb-4">
 2.0 Traditional friction-based Fastening System
 </h3>
 <p className="text-gray-300 leading-relaxed mb-4">
 The core mechanism of a friction-based system is fundamentally reliant on friction. It employs a high-torque,
 ...
 <p className="text-gray-300 leading-relaxed mb-4">
 The AngleLock system was conceived as a direct engineering response to friction-based weaknesses. Instead of
 ...
 <th className="p-4 text-[#C9A227] font-bold border border-[#2C4A6E]">Traditional friction-based</th>
 ...
 <p className="text-gray-300 leading-relaxed mb-4">
 The friction-based system's reliance on single-plane friction introduces inherent, predictable failure modes under

...
export default async function SolutionDetailPage({ params }: { params: Promise<{ slug: string }> }) {
 ...
 Traditional framing systems rely on friction-based friction-based connections that loosen
 ...
 <p className="text-white/90 text-sm font-semibold">Stronger than friction-based</p>
 </div>
 <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
 <div className="text-5xl font-bold text-[#C9A227] font-['Barlow_Condensed'] mb-2">
 0

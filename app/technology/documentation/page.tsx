...
export default function TechnicalDocumentationPage() {
 ...
 <Link href="/compare/friction-based" className="block p-6 bg-slate-50 rounded-lg border border-slate-200 hover:border-[#C9A227] hover:shadow-md transition-all">
 <div className="flex items-center justify-between">
 <div>
 <h3 className="font-bold text-[#0A1628] mb-1">AngleLock vs. friction-based Comparison</h3>
 <p className="text-slate-600 text-sm">Technical comparison with traditional friction-based systems</p>
 </div>
 <ArrowRight className="w-5 h-5 text-[#C9A227]" />
 </div>
 </Link>

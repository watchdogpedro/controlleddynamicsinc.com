...
export default function TechnologyPage() {
 ...
 traditional friction-based systems.
 </p>
 </motion.div>
 </Container>
 </section>
 ...
 The Problem with Traditional friction-based Systems
 </h2>
 <p className="text-[#6B7C93] leading-relaxed mb-4">
 Traditional aluminum framing relies on friction-based friction-based connections.
 ...
 <span className="text-[#6B7C93]"> 10x traditional friction-based connections</span>
 </div>
 </li>
 <li className="flex items-start gap-3">
 <CheckCircle2 className="w-6 h-6 text-[#C9A227] flex-shrink-0 mt-0.5" />
